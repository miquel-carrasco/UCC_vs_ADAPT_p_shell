...
if __name__ == '__main__':
    ...
    ADAPT = ADAPTVQE(ansatz, method='L-BFGS-B', conv_criterion='Repeated op', max_layers=100, return_data=True, test_threshold=1e-4, tol_method='Manual')

    gradient_layers, opt_grad_layers, energy_layers, rel_error_layers, fcalls_layers = ADAPT.run()

    # print("GRADIENTS: ",gradient_layers)
    # print("ENERGY: ",energy_layers)
    # print("LABELS: ",[op.ijkl for op in ansatz.added_operators])